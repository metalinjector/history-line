 ...
 * хронологии: `content/items/<страна>/<id>.md`. В шапке файла (front-matter)
 * записаны источники и, если нужно, расхождения в трактовках; ниже — статья
 * для модального окна. Статья необязательна: файл только с источниками
 * совершенно нормален.
 *
...
const modules = import.meta.glob<ContentModule>('../../content/items/*/*.md', { eager: true });

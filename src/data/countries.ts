...
const seeds: CountrySeed[] = [
  ...
  historical('achaemenid-persia', 'Персидская держава Ахеменидов', 'ПЕ', 'Империя Ахеменидов VI–IV веков до н. э.', ['Персия', 'Ахемениды']),
...
/** Начальный набор сохраняет привычную и читаемую раскладку первой версии. */

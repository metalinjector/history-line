...
const steps = [
  ...
  },
  {
    ...
    text: 'Карточка отвечает на три вопроса: что произошло, почему это важно и как это связано с параллельной историей. Значок в углу карточки открывает полный текст со схемами, таблицами и ссылками.',
  },
];
...
const roadmap = [
  ...
  {
    title: 'Источники и экспорт',
    text: 'Ссылки на литературу и документы у каждой карточки, пользовательские подборки событий и экспорт выбранной хронологии в PDF.',
    status: 'в планах',
  },
];

...
const steps = [
  ...
  {
    label: 'Справа — страны',
    text: 'Каждая страна — своя вертикальная линия со своим цветом. Колонок на экране не больше шести, поэтому близкие линии могут делить дорожку: цвет точки говорит, к какой стране относится событие.',
  },
  {
